...
SOURCES =  valor.c cluster.c clique.c clique_inter.c bitset.c hashtable.c statistics.c graph.c common.c vector.c set.c interval10X.c structural_variation.c interc_sv.c cnv.c readbam.c readbed.c recovermolecules.c progress.c cmdline.c config.c valorconfig.c dna_4X_encoding.c
OBJECTS = $(SOURCES:.c=.o)
EXECUTABLE = valor
